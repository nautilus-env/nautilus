//! The `generator` block: which client it generates, where it writes and the
//! per-language options that only some clients accept.

use crate::validator::*;

impl SchemaValidator<'_> {
    pub(in crate::validator) fn validate_generators(&mut self) {
    ...
    pub(in crate::validator) fn validate_generator(&mut self, generator: &GeneratorDecl) {
    ...
    pub(in crate::validator) fn generator_provider_info(
    ...
    pub(in crate::validator) fn generator_output_value(
        generator: &GeneratorDecl,
    ...
    pub(in crate::validator) fn generator_java_output_required(
        generator: &GeneratorDecl,
    ...
    pub(in crate::validator) fn generator_interface_kind(
        generator: &GeneratorDecl,
    ...
    pub(in crate::validator) fn generator_recursive_type_depth(
        generator: &GeneratorDecl,
        client_provider: ClientProvider,
        provider: &str,
    ) -> Result<usize> {
    ...
    pub(in crate::validator) fn generator_java_package_value(
        generator: &GeneratorDecl,
        client_provider: ClientProvider,
    ) -> Result<Option<String>> {
    ...
    pub(in crate::validator) fn generator_java_group_id_value(
        generator: &GeneratorDecl,
        client_provider: ClientProvider,
    ) -> Result<Option<String>> {
    ...
    pub(in crate::validator) fn generator_java_artifact_id_value(
        generator: &GeneratorDecl,
        client_provider: ClientProvider,
    ) -> Result<Option<String>> {
    ...
    pub(in crate::validator) fn generator_java_mode_value(
        generator: &GeneratorDecl,
        client_provider: ClientProvider,
    ...
    pub(in crate::validator) fn valid_generator_fields(
