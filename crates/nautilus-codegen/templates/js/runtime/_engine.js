...
export class EngineProcess {
    ...
    _poolArgs() {
        ...
        if (this.poolOptions.statementCacheCapacity != null) {
            args.push('--statement-cache-capacity', String(this.poolOptions.statementCacheCapacity));
        }
        if (this.poolOptions.statementTimeoutMs != null) {
            args.push('--statement-timeout-ms', String(this.poolOptions.statementTimeoutMs));
        }
        if (this.poolOptions.maxConcurrentRequests != null) {
            args.push('--max-concurrent-requests', String(this.poolOptions.maxConcurrentRequests));
        }
        return args;
    }
    get stdin() {
    ...
    _findEngine(schemaPath) {
        ...
        throw new Error(`nautilus binary not found in PATH.\n` +
